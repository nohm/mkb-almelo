...
var retrieveRSS=function(){$.get(REQUESTURL,function(t){parseRSS(t)})},parseRSS=function(t){var e=$("#rsscontainer"),i=$("#rssholder"),a=!0;$(t).find("item").each(function(){var t=$(this).find("title").text(),s=$(this).find("link").text(),n=$(this).find("description").text();if(a){var r=$("<div></div>").addClass("row");r.append('<div class="col-lg-6 col-lg-offset-3"><h2><a href="'+s+'">'+t+'</a></h2><i class="fa fa-twitter tweet" onclick="tweet(\''+s+"','"+TWITTER_MKB+"','"+t+"')\"></i><p>"+n+"</p></div>"),e.prepend(r),a=!1}else i.append('<div class="col-lg-3"><h2><a href="'+s+'">'+t+'</a></h2><i class="fa fa-twitter tweet" onclick="tweet(\''+s+"','"+TWITTER_MKB+"','"+t+"')\"></i><p>"+n+"</p></div>")})};
