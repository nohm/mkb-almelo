var PROXYURL="php/proxy.php",RSSURL="http://www.mkb.nl/data/blog/7/rssfeed.xml",REQUESTURL=PROXYURL+"?url="+RSSURL,TWITTER_MKB="mkbnl";
...
var PROXYURL="php/proxy.php",RSSURL="http://www.mkb.nl/data/blog/7/rssfeed.xml",REQUESTURL=PROXYURL+"?url="+RSSURL;!function(t){var i=function(){t.get(REQUESTURL,function(t){e(t)})},e=function(i){var e=t("#rsscontainer"),n=t("#rssholder"),a=!0;t(i).find("item").each(function(){var i=t(this).find("title").text(),s=t(this).find("link").text(),l=t(this).find("description").text();if(a){var c=t("<div></div>").addClass("row");c.append('<div class="col-lg-6 col-lg-offset-3"><h2><a href="'+s+'">'+i+'</a></h2><i class="fa fa-twitter tweet" onclick="tweet(\''+s+"','"+TWITTER_MKB+"','"+i+"')\"></i><p>"+l+"</p></div>"),e.prepend(c),a=!1}else n.append('<div class="col-lg-3"><h2><a href="'+s+'">'+i+'</a></h2><i class="fa fa-twitter tweet" onclick="tweet(\''+s+"','"+TWITTER_MKB+"','"+i+"')\"></i><p>"+l+"</p></div>")})},n=function(){i()};t(n)}(jQuery);
var tweet=function(t,e,n){var t=["https://twitter.com/intent/tweet?tw_p=tweetbutton","&url=",encodeURI(t),"&via=",e,"&text=",n].join("");window.open(t,"Tweet","height=500,width=700")};