var config={mkb:{request_url:"php/proxy.php?type=xml&url=http://www.mkb.nl/data/blog/7/rssfeed.xml",container:"#rsscontainer_mkb",holder:"#rssholder_mkb"},wo:{base_url:"http://www.wijoverijssel.nl",request_url:"php/proxy.php?type=html&url=http://www.wijoverijssel.nl/hotspots/wijoverijssel",container:"#rsscontainer_wo",holder:"#rssholder_wo"},twitter_mkb:"mkbnl",windowSize:{height:500,width:700}};
...
function mkbRSS(i){var n={urls:[],titles:[],descriptions:[]};$.get(i.request_url,function(t){var r=$(i.container),a=$(i.holder),s=!0;$(t).find("item").each(function(i){var t=$(this).find("title").text(),d=$(this).find("link").text(),l=$(this).find("description").text();if(n.urls.push(d),n.titles.push(t),n.descriptions.push(l),s){var p=$("<div></div>").addClass("row"),o=$("<div></div>").addClass("col-lg-6 col-lg-offset-3");o.append(e(d,t,i,l)),p.append(o),r.prepend(p),s=!1}else{var o=$("<div></div>").addClass("col-lg-3");o.append(e(d,t,i,l)),a.append(o)}})});var e=function(i,n,e,t){return'<h2><a href="'+i+'">'+n+"</a></h2><p>"+t+"</p>"}}function woRSS(i){var n={urls:[],descriptions:[]};$.get(i.request_url,function(t){var r=($(i.container),$(i.holder));t=t.replace(/<img\b[^>]*\/>/gi,""),t=$(t);var a=t.find(".midCol").find("ul").filter(function(){return this.id.match(/(spotlight_).*/)});a.find("li").each(function(t,a){var s=$(a).find("a")[0],d=i.base_url+s.href.replace(/^.*\/\/[^\/]+/,""),l=s.innerHTML.split("</span> ")[1].split("<span ")[0];n.urls.push(d),n.descriptions.push(l);var p=$("<div></div>").addClass("col-lg-3");p.append(e(d,l)),r.append(p)})});var e=function(i,n){return'<h2><a href="'+i+'">'+n+"</a></h2>"}}var global;