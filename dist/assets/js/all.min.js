var PROXYURL="php/proxy.php",RSSURL="http://www.mkb.nl/data/blog/7/rssfeed.xml",REQUESTURL=PROXYURL+"?url="+RSSURL,TWITTER_MKB="mkbnl",WINDOWSIZE={height:500,width:700};
...
var tweet=function(t){var e=["https://twitter.com/intent/tweet?tw_p=tweetbutton","&url=",encodeURI(SOCIAL.urls[t]),"&via=",TWITTER_MKB,"&text=",SOCIAL.titles[t]].join("");window.open(e,"Tweet",windowFormat())},facebook=function(t){var e=["http://www.facebook.com/sharer.php?s=100","&p[title]=",SOCIAL.titles[t],"&p[summary]=",SOCIAL.descriptions[t],"&p[url]=",encodeURI(SOCIAL.urls[t])].join("");window.open(e,"Share",windowFormat())},windowFormat=function(){var t=screen.height/2-WINDOWSIZE.height/2,e=screen.width/2-WINDOWSIZE.width/2;return"top="+t+",left="+e+",toolbar=0,status=0,width="+WINDOWSIZE.width+",height="+WINDOWSIZE.height},SOCIAL={urls:[],titles:[],descriptions:[]},retrieveRSS=function(){$.get(REQUESTURL,function(t){parseRSS(t)})},parseRSS=function(t){var e=$("#rsscontainer"),i=$("#rssholder"),o=!0;$(t).find("item").each(function(t){var s=$(this).find("title").text(),a=$(this).find("link").text(),n=$(this).find("description").text();if(SOCIAL.urls.push(a),SOCIAL.titles.push(s),SOCIAL.descriptions.push(n),o){var r=$("<div></div>").addClass("row");r.append('<div class="col-lg-6 col-lg-offset-3"><h2><a href="'+a+'">'+s+'</a></h2><i class="fa fa-twitter tweet" title="Deel dit op Twitter!" onclick="tweet('+t+')"></i><i class="fa fa-facebook share" title="Deel dit op Facebook!" onclick="facebook('+t+')"></i><p>'+n+"</p></div>"),e.prepend(r),o=!1}else i.append('<div class="col-lg-3"><h2><a href="'+a+'">'+s+'</a></h2><i class="fa fa-twitter tweet" title="Deel dit op Twitter!" onclick="tweet('+t+')"></i><i class="fa fa-facebook share" title="Deel dit op Facebook!" onclick="facebook('+t+')"></i><p>'+n+"</p></div>")})};