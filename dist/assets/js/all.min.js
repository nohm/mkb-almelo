...
function mkbRSS(e){var i={urls:[],titles:[],descriptions:[]};$.get(e.request_url,function(r){var t=$(e.container),a=$(e.holder),s=!0;$(r).find("item").each(function(e){var r=$(this).find("title").text(),d=$(this).find("link").text(),l=$(this).find("description").text();if(i.urls.push(d),i.titles.push(r),i.descriptions.push(l),s){var p=$("<div></div>").addClass("row"),o=$("<div></div>").addClass("col-lg-6 col-lg-offset-3");o.append(n(d,r,e,l)),p.append(o),t.prepend(p),s=!1}else{var o=$("<div></div>").addClass("col-lg-3");o.append(n(d,r,e,l)),a.append(o)}})});var n=function(e,i,n,r){return'<h2><a href="'+e+'">'+i+"</a></h2><p>"+r+"</p>"}}function woRSS(e){var i={urls:[],descriptions:[]};$.get(e.request_url,function(r){var t=($(e.container),$(e.holder));r=r.replace(/<img\b[^>]*\/>/gi,""),r=$(r),r.find(".nieuwsoverzicht-artikelkop").each(function(r,a){var s=$(a).find("a")[0],d=e.base_url+s.href.replace(/^.*\/\/[^\/]+/,""),l=s.innerHTML;i.urls.push(d),i.descriptions.push(l);var p=$("<div></div>").addClass("col-lg-3");p.append(n(d,l)),t.append(p)})});var n=function(e,i){return'<h2><a href="'+e+'">'+i+"</a></h2>"}}